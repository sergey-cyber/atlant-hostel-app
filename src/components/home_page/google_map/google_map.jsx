...
const GoogleMap = () => {
    return (
        <section className={style.googleMap} id='toGoogleMapScroll'>
            ...
            {/* Yandex map */}
            <iframe src="https://yandex.ru/map-widget/v1/?um=constructor%3A1ed9c1b6efc2e5fffa7abc41ca96c31346338807ca306af2f4b6538be452d368&amp;source=constructor" width="100%" height="400" frameborder="0"></iframe>
            {/* Google Map */}
