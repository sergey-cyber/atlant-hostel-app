...
const initialState = {
  ...
  roomsImages: [
    ...
    { bedsNumbers: 12, images: [room1234, room1234_1] },
    { bedsNumbers: 34, images: [room1234, room1234_1] },
    { bedsNumbers: 56, images: [room5678, room5678_1] },
    { bedsNumbers: 78, images: [room5678, room5678_1] },
...
export const setSelectedDateToState = (selectedDates) => ({
...
export const setPaymantSuccessfulFlag = (isSuccessful) => ({
  type: SET_PAYMENT_SUCCESSFUL_FLAG,
  isSuccessful,
});
